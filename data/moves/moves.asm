...
; entries correspond to constants/move_constants.asm
	...
	move PAY_DAY,      EFFECT_PAY_DAY,            50, NORMAL,   100, 20,   0
	...
	move BIND,         EFFECT_TRAP_TARGET,        25, GRASS,     95, 20,   0
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         65, FIGHTING, 100, 15,  30
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          20, FLYING,    95, 20,   0
	...
	move WRAP,         EFFECT_TRAP_TARGET,        25, NORMAL,    95, 20,   0
	...
	move WATER_GUN,    EFFECT_SP_ATK_DOWN,        40, WATER,    100, 25,  10
	move HYDRO_PUMP,   EFFECT_SP_ATK_DOWN,       120, WATER,     85,  5,  30
	move SURF,         EFFECT_NORMAL_HIT,         90, WATER,    100, 15,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         95, ICE,      100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,       85,  5,  20
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,    95,  5,   0
	...
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, FIGHTING,  95, 20,  30
	...
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         65, GRASS,    100, 25,   0
	move SOLARBEAM,    EFFECT_RECOIL_HIT,        120, GRASS,    100, 10,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        35, FIRE,      95, 15,   0
	...
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC,  100, 10,  20
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC,   70, 20,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,    95, 10,   0
	move LICK,         EFFECT_PARALYZE_HIT,       25, GHOST,    100, 30,  30
	move SMOG,         EFFECT_POISON_HIT,         40, POISON,    70, 20,  40
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON,   100, 20,  20
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,    95, 20,  20
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,      85,  5,  30
	move WATERFALL,    EFFECT_FLINCH_HIT,         85, WATER,    100, 15,  30
	move CLAMP,        EFFECT_TRAP_TARGET,        35, ICE,       95, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         65, NORMAL,   100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        120, NORMAL,   100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          25, ROCK,      95, 15,   0
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     20, NORMAL,   100, 35, 100
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         100, FIGHTING,  95, 20,   0
	...
	move BARRAGE,      EFFECT_MULTI_HIT,          20, GRASS,     95, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          50, BUG,      100, 15,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,    85, 10,   0
	move SKY_ATTACK,   EFFECT_HYPER_BEAM,        140, FLYING,    95, 10,   0
	...
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC,  100, 20,   0
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,   100, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,   100, 40,   0
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        105, WATER,     95, 10,   0
	move EXPLOSION,    EFFECT_SELFDESTRUCT,      250, NORMAL,   100,  5,   0
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          20, NORMAL,    95, 15,   0
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         60, GROUND,    90, 10,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC,  100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         85, ROCK,      95, 10,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         90, NORMAL,    95, 15,  20
	...
	move CROSS_CUTTER, EFFECT_NORMAL_HIT,         70, BUG,      100, 25,   0
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,     100, 25,  20
	...
	move AEROBLAST,    EFFECT_FLINCH_HIT,        100, FLYING,   100,  5,  50
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         95, POISON,   100, 10,  20
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  30, GROUND,   100, 10,  50
	move OCTAZOOKA,    EFFECT_SPEED_DOWN_HIT,     85, WATER,     95, 10,  50
	...
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, GROUND,    95, 10,   0
	...
	move FALSE_SWIPE,  EFFECT_FALSE_SWIPE,        60, NORMAL,   100, 40,   0
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        20, BUG,       90, 20,   0
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     70, STEEL,     90, 25,  50
	...
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,   100, 25,   0
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         50, ROCK,      95,  5,  30
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    85, GHOST,    100, 15,  20
